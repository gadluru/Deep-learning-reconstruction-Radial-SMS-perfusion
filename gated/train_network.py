...
parameters = {'N':N, 'batch':batch, 'in_features':in_features,'out_features':out_features,'resolution':resolution, 'layers':layers,'dp':dp,'alpha':alpha,'beta':beta,'save_directory':save_directory}
